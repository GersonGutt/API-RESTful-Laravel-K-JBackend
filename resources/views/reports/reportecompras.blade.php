...
<table class="table">
    ...
    <tbody>
      <tr>
        ...
        <div class="texto-destacado">Reporte de Compras</div>
  ...
  <table class="table table-striped bordes-table">
    ...
    <tr>
        <th class="right texto-destacado">NUMERO DE COMPRA</th>
    <th class="texto-destacado">DESCUENTO</th>
    <th class="right texto-destacado">FECHA DE LA COMPRA</th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="left strong texto-destacado">%{{ $item['descuento'] }}</td>
        <td class="left texto-destacado">{{  $item['fechaCompra'] }}</td>
...
<div class="card-footer bg-white mt-0">
   <p class="texto-destacado"><strong>Total en Compras: ${{ $total }}</strong></p>
    </div>
